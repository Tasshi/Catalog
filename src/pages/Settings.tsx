...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      if (!uid) {
        console.log('❌ no uid found after polling');
        return;
      }
      if (cancelled) {
      ...
      const [{ data: groupData, error: groupErr }, { data: profileData, error: profileErr }] =
        await Promise.all([
              ...
              <div className="animate-pulse">
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    />
                    <div
                      style={{ width: 180, height: 12, background: '#f3f4f6', borderRadius: 6 }}
                    />
                  </div>
                </div>
                <div style={{ marginBottom: 16 }}>
                  ...
                  />
                  <div
                    style={{ width: '100%', height: 48, background: '#f3f4f6', borderRadius: 12 }}
                  />
                </div>
                ...
                <div
                  style={{ width: '100%', height: 48, background: '#e5e7eb', borderRadius: 12 }}
                />
              </div>
            </div>
          </div>
